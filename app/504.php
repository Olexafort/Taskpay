			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="price.html">My Jobs</a></li>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"> <a href="#"> <p style="color: red; font-family: calibri;"> <?php if(isset($_GET['msg'])) {echo $_GET['msg']; } ?></p> </a></p>
						</div>											
					</div>
				</div>
			</section>
