				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="location_jobs.php?location=<?php if(isset($_GET['location'])) { echo $_GET['location']; } ?>" > <?php if(isset($_GET['location'])) { echo $_GET['location']; } ?> Jobs</a></p>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row justify-content-center d-flex">
						<div class="col-lg-8 post-list">
							...
							if (isset($_GET['location'])) {
								...
								$task->select_jobs_by_location($location);
							}
							?>
